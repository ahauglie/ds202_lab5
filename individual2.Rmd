...
ggplot(county, aes(x=long, y=lat))+geom_polygon(aes(group=group))+geom_point(aes(x=LONGITUD, y=LATITUDE), data=three_join %>% filter(LONGITUD <0 & LONGITUD> -130), size=0.001, color="firebrick2")
