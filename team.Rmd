...
#Throw a chart in here
ggplot(data = acc.drivers.clean, aes(x=DAY_WEEK)) + geom_histogram(color="black", fill="light blue") + ylab("Total Number of Accidents") + xlab("Day of the week") + ggtitle("Total Accidents on each Given Week day")
#
###USE DISTINCT TO TRIM IT DOWN
```
